...
- **Preferred Name:** MJ
- **UT NetID:** `mbae`
- **GitHub Username:** `mazinouruk`
- **Major:** Computer Science (Undergrad) / Japanese WLC
...
- **Programming Languages:** Python, C/C++, Bash, ASM
- **Development & System Tools:** GitLab, Linux, Docker, KiCAD, Kubernetes, Tailscale
